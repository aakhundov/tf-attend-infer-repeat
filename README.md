Implementation of **AIR** framework proposed in "Attend, Infer, Repeat: Fast Scene Understanding with Generative Models" paper by Eslami et al. (https://arxiv.org/abs/1603.08575).
